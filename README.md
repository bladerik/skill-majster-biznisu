...
**Skill builder podľa metodiky Majster Biznisu**: sprievodca, ktorý ťa prevedie od konkrétneho opakovaného postupu v tvojom biznise k novému použiteľnému AI skillu.
...
1. **Identifikuje** opakovaný digitálny postup v tvojom biznise
2. **Zmapuje,** aký kontext (pravidlá, príklady, referencie) skill potrebuje
3. **Definuje** bezpečnostné hranice: čo AI smie, kde musí pýtať schválenie, čo nesmie nikdy
...
**Poznámka:** v ChatGPT bez Custom GPT s prístupom k súborom alebo v Claude.ai bez harnessu skill nedokáže súbor uložiť. Spusti ho v jednom z podporovaných agentov.
...
1. **Context is King**: kvalita AI výstupu závisí hlavne od kontextu, ktorý agent dostane, nie len od promptu, ktorý napíšeš.
2. **Pattern Replication**: kvalita skillu sa rovná kvalite pochopenia postupu, ktorý replikuje.
3. **Internal beats Commercial**: interný skill postavíš za minúty alebo hodiny. Komerčný produkt trvá mesiace. Nečakaj na "AI pre tvoj sektor". Postav si vlastný.

## Pre koho je tento skill

Pre podnikateľov, ktorí:
- absolvovali prednášku Majster Biznisu (alebo videli jej záznam)
- majú v hlave alebo v SOP dokumentoch jasný opakovaný postup
